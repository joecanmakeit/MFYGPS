...
public class GuiGPS extends Gui {
	...
	static final ResourceLocation guiTexture = new ResourceLocation("mfygps:textures/gui/gps-background.png");
	...
	public void eventHandler(RenderGameOverlayEvent e) {
		...
		if (	(currItem != null && currItem.getItem() == MFYGPS.handheldGPS) || 
				(currHelmet != null && currHelmet.getItem() == MFYGPS.gpsHeadset)) {
			// Draw Background
